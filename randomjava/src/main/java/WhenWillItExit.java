 ...
 * Don't attempt to install binutils through Homebrew or any other package manager, as the Makefile expects to
 * hand-build binutils itself. You'll get a funny message about the configure script going missing otherwise.
 *
...
public class WhenWillItExit {
    public static void main(String[] argc) throws InterruptedException {
         ...
         * cooperation of all threads in order to proceed. It seems like exiting the JVM is one of them.
         */
        Thread t = new Thread(() -> {
            long l = 0;
            /**
            ...
            for (int i = 0; i < Integer.MAX_VALUE; i++) {
                /**
                 * However, a safepoint poll shows up in this for loop. You can see it in the disassembler:
                 *   0x0000000103301822: test   %eax,-0x212a828(%rip)        # 0x00000001011d7000
                 ;*iload_3
                 ; - WhenWillItExit::lambda$main$0@12
                 ;   {poll}
                 * Maybe the JVM is smart enough to recognize nested loops as potentially playing poorly with
                 * safepoints.
                 */
